...
const Hero = () => (
  <section className="relative overflow-hidden bg-zinc-950 dark:bg-zinc-950 bg-white dark:bg-zinc-950 pt-20 pb-12 md:pt-32 md:pb-24 transition-colors duration-500">
    <div className="absolute inset-0 opacity-30 dark:opacity-30 opacity-0 transition-opacity duration-500">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-16 md:gap-24">
        <div className="flex-1 text-center lg:text-left space-y-8 md:space-y-12">
          <div className="flex flex-col items-center lg:items-start gap-4 mb-6">
            ...
            <div className="inline-flex items-center gap-3 bg-zinc-900/5 dark:bg-white/5 backdrop-blur-xl border border-zinc-900/10 dark:border-white/10 px-5 py-2.5 rounded-2xl text-purple-700 dark:text-purple-400 text-xs md:text-sm font-black uppercase tracking-[0.3em] animate-in fade-in slide-in-from-bottom-4 duration-700">
              <Zap size={16} className="animate-pulse" />
              Marketplace #1 de Angola
            </div>
          </div>
          
          <h1 className="text-5xl md:text-8xl lg:text-9xl font-black text-zinc-950 dark:text-white leading-[0.85] tracking-[-0.04em] animate-in fade-in slide-in-from-bottom-8 duration-1000">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 pt-6 animate-in fade-in slide-in-from-bottom-16 duration-1000 delay-300">
            <button className="w-full sm:w-auto bg-zinc-950 dark:bg-white text-white dark:text-zinc-950 hover:bg-purple-700 dark:hover:bg-purple-600 hover:text-white px-12 py-6 rounded-[24px] font-black text-xl shadow-2xl shadow-purple-500/20 dark:shadow-white/5 active:scale-95 transition-all duration-500">
              Explorar Ofertas
            </button>
            <button className="w-full sm:w-auto bg-zinc-100 dark:bg-white/5 hover:bg-zinc-200 dark:hover:bg-white/10 text-zinc-950 dark:text-white border border-zinc-200 dark:border-white/10 px-12 py-6 rounded-[24px] font-black text-xl backdrop-blur-xl active:scale-95 transition-all duration-500">
              Como Funciona
            </button>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 pt-12 md:pt-16 animate-in fade-in duration-1000 delay-500">
            {[
              ...
              <div key={i} className="flex flex-col items-center lg:items-start gap-3 group cursor-default">
                <div className="p-3 rounded-2xl bg-zinc-100 dark:bg-white/5 border border-zinc-200 dark:border-white/5 group-hover:bg-zinc-200 dark:group-hover:bg-white/10 group-hover:border-zinc-300 dark:group-hover:border-white/10 transition-all duration-500">
        ...
        <div className="flex-1 relative w-full lg:block animate-in fade-in zoom-in duration-1000 delay-300">
          <div className="relative z-10 bg-white dark:bg-gradient-to-br dark:from-zinc-900 dark:to-black p-4 md:p-5 rounded-[32px] md:rounded-[64px] border border-zinc-200 dark:border-white/10 shadow-2xl shadow-zinc-500/10 dark:shadow-purple-500/10 group mx-auto max-w-lg lg:max-w-none transition-colors duration-500">
            ...
            <div className="absolute -top-6 -right-6 md:-top-12 md:-right-12 bg-white dark:bg-zinc-900 p-4 md:p-8 rounded-2xl md:rounded-[32px] shadow-2xl border border-zinc-200 dark:border-zinc-800 animate-bounce duration-[4000ms]">
              <div className="flex items-center gap-3 md:gap-5">
                ...
                <div>
                  ...
                  <p className="text-sm md:text-xl font-black text-zinc-950 dark:text-white">Pagamento Seguro</p>
                </div>
              </div>
            </div>
