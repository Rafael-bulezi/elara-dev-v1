  ...
  <footer className="bg-zinc-950 text-white pt-20 pb-10">
    <div className="container mx-auto px-4">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
        <div className="space-y-8">
          ...
          <div className="flex items-center gap-4">
            {[Facebook, Instagram, Twitter].map((Icon, i) => (
              <button key={i} className="w-12 h-12 bg-white/5 hover:bg-purple-600 text-white rounded-2xl flex items-center justify-center transition-all duration-300 active:scale-90 border border-white/10">
                <Icon size={20} />
              </button>
            ))}
          </div>
        ...
        <div>
          <h4 className="text-xl font-black mb-8 uppercase tracking-widest text-purple-400">Categorias</h4>
          <ul className="space-y-4">
            {['Eletrónicos', 'Computadores', 'Moda', 'Casa', 'Ferramentas', 'Fotografia'].map((item, i) => (
              <li key={i}>
                <a href="#" className="text-zinc-400 hover:text-white transition-colors font-bold text-lg flex items-center gap-3 group">
        ...
        <div>
          <h4 className="text-xl font-black mb-8 uppercase tracking-widest text-blue-400">Suporte</h4>
          <ul className="space-y-4">
        ...
        <div className="space-y-8">
          <h4 className="text-xl font-black mb-8 uppercase tracking-widest text-emerald-400">Newsletter</h4>
          <p className="text-zinc-400 font-medium">Receba as melhores ofertas e novidades diretamente no seu e-mail.</p>
          <div className="relative group">
            <input 
              type="email" 
              placeholder="seu@email.com" 
              className="w-full bg-white/5 border-2 border-white/10 focus:border-purple-500/50 py-4 px-6 rounded-2xl text-white font-bold outline-none transition-all"
            />
          ...
          <div className="flex items-center gap-4 pt-4">
            <div className="flex flex-col">
              <span className="text-2xl font-black text-white">250k+</span>
