...
import { Search, ShoppingCart, Moon, Sun, Menu, PlusCircle, Globe } from 'lucide-react';
      ...
      <div className="h-14 md:h-20 flex items-center justify-between gap-3 md:gap-8">
        ...
        <div className="flex items-center gap-1 md:gap-4">
          ...
          <button 
            ...
            className="hidden lg:flex items-center gap-2 bg-purple-600 text-white px-5 py-2.5 rounded-xl font-black text-sm hover:scale-105 active:scale-95 transition-all shadow-lg shadow-purple-500/20"
          >
            <Globe size={18} />
            Importar
          </button>
