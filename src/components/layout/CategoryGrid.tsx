  ...
  <section className="px-4">
    <div className="container mx-auto">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg md:text-xl font-bold text-zinc-900">Comprar por categoria</h2>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-3">
        {categories.map((cat) => (
          <button
            ...
            className="group flex flex-col items-center text-center gap-3 p-4 bg-white border border-zinc-200 rounded-xl hover:border-purple-500/50 hover:shadow-sm transition-all"
          >
